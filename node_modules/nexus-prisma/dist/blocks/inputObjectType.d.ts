...
export declare function prismaInputDefinitionBlock<TypeName extends string>(typeName: string, t: core.InputDefinitionBlock<TypeName> | core.OutputDefinitionBlock<TypeName>, prismaType: Record<string, core.NexusInputFieldConfig>, prismaSchema: GraphQLSchema): PrismaInputDefinitionBlock<TypeName>;
export declare function prismaTypeInputObject(prismaSchema: GraphQLSchema, inputObjectConfig: PrismaInputObjectTypeConfig<any>): Record<string, core.NexusInputFieldConfig>;
